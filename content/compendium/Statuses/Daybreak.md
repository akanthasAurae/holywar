...
> 
> When triggered, <img src="eruption.png" class=icon> <span class=daybreak>Eruption</span> forcibly inflicts 2 ![[stancebreak.png|icon]] [[Stancebroken]], ignoring any passives that would prevent its affliction.
> 
> Like ![[radiance.png|icon]] [[Radiance]], ![[daybroken.png|icon]] <span class=daybreak>Daybreak</span> decays at a rate of one level of ![[daybroken.png|icon]] <span class=daybreak>Daybreak</span> per ![[action.png|icon]] [[Actions|Action]] taken, consuming one ![[vital.png|icon]] [[Vitality]] per decayed level.
> 
> *Unique ![[burn.png|icon]] [[Burn]] and ![[radiance.png|icon]] [[Radiance]].*