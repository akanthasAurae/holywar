...
> [!crit|status|none]
> <img src="crit.png" class="floatl"><span> <span class=crit>Critical Hits</span> are attacks that involve heavily wounding the enemy within a short period of time. Landing <img src="crit.png" class="icon"> <span class=crit>Critical Hits</span> naturally removes one <img src="vital.png" class="icon"> <a data-href="Vitality" href="Vitality" class="internal-link">Vitality</a> from the enemy no matter what.</span>
> 
